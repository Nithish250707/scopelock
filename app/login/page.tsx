                ...
                <div className="rounded-2xl border border-[#2a2a2a] bg-[#1a1a1a] p-8 shadow-2xl shadow-black/40">
                    ...
                    <div className="mb-8 text-center">
                        ...
                        <p className="mt-2 text-sm text-[#a1a1aa]">
                            Log in to manage your proposals and projects
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            <div className="mb-1.5 flex items-center justify-between">
                                <label
                                    htmlFor="password"
                                    className="block text-sm font-medium text-[#d4d4d8]"
                                >
                                    Password
                                </label>
                                <Link
                                    href="#"
                                    className="text-xs text-[#7c3aed] transition-colors hover:text-[#8b5cf6]"
                                >
                                    Forgot password?
                                </Link>
                            </div>
